...
const styles = {
  ...
  tag: { position: "absolute", top: "20px", right: "20px", background: "#dcfce7", color: "#166534", fontSize: "11px", fontWeight: "700", padding: "4px 10px", borderRadius: "20px", letterSpacing: "0.05em" },
  ...
  req: { color: "#ef4444" },
  input: { padding: "10px 14px", borderRadius: "8px", border: "1.5px solid #d1fae5", fontSize: "14px", outline: "none", background: "#f9fafb", transition: "border 0.2s" },
